...
def run_cho(dl_version, Ud, dose_level, isIO, bt_size, lambda_val_ind_chdiff, lambda_val_ind_mdiff):
  ...
  save_folder = f'{base_folder}/learning/v1_july_22_unet_3d/den_3d_v{dl_version}/pred_tSN_fix3_ms_comb_mirirv3/lmbd_mdiff{lambda_val_ind_mdiff}/d{dose_level}'
  ...
  if isIO == 1:
    ...
    fname_tSN = f'{save_folder}/tSN_seall_d{dose_level}_c30o5_IO{isIO}_Ud{Ud}_lmbdchdiff{lambda_val_ind_chdiff}_lmbdmdiff{lambda_val_ind_mdiff}_rerun.txt'
