...
def run_cho(Ud, dose_level, isIO, gender):
  ...
  save_folder = f'{base_folder}/test_data_sa_wd_tSN_fix3_remsev500ext90addsev175_combined_mirirv3_gender_48cube'
  ...
  if isIO == 1:
    ...
    fname_tSN = f'{save_folder}/tSN_seall_d{dose_level}_c30o5_IO{isIO}_Ud{Ud}_{gender}_ext45.txt'
    ...
    fname_tSN = f'{save_folder}/tSN_seall_d{dose_level}_c30o5_IO{isIO}_Ud{Ud}_{gender}.txt'
    with open(fname_tSN, 'w') as f:
      f.writelines('Initial Line\nLarge\n')
      for dd in tN:
          f.writelines(f"{dd}\n")
...
if __name__ == '__main__':
  ...
  run_cho(args.Ud, args.dose_level, args.isIO, args.gender)
