...
#do
  ...
  do
    ...
    do
      ...
      do
        ...
        if [[ ! -d $full_learning_folder/pred/${def_name} ]]
        then
          mkdir -p $full_learning_folder/pred/${def_name}
          echo "Making dir: $full_learning_folder/pred/${def_name}"
        fi
        ...
        do
          ...
          #do
            ...
            echo "python3 test_3Dden_AR_NaI_v${version}.py ${arglist[@]}"
            python3 test_3Dden_AR_NaI_v${version}.py ${arglist[@]}
          #done
        done
      done
    done
  ...
  do
    ...
    #do
      ...
      echo "python3 test_3Dden_AR_NaI_v${version}_hl.py ${arglist[@]}"
      python3 test_3Dden_AR_NaI_v${version}_hl.py ${arglist[@]}
    #done
  done
#done
