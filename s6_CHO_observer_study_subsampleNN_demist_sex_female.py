...
file_path_def = '/data01/user-storage/y.zezhang/2024_subsample_project/document/combined_final_test_pat_list_def.txt'
male_list_def, female_list_def = categorize_by_gender(file_path_def)

file_path_hl = '/data01/user-storage/y.zezhang/2024_subsample_project/document/combined_final_test_pat_list_hl_v2.txt'
...
for study_project in observer_study_list:
  ...
  fname_tSN = f'{save_folder}/t_de_fe_loc_{location_setting_combined}_sev_{severity_setting_combined}_ext_{extent_setting_combined}_subsample{study_project}_IO{isIO}_Ud{Ud}.txt'
