...
def run_cho(Ud, dose_level, isIO, ext_ind):
  ...
  save_folder = f'{base_folder}/test_data_sa_wd_tSN_fix3_remsev500ext90addsev175_combined_mirirv3_def_ext_48cube/extind_{ext_ind}'
  ...
  if isIO == 1:
    ...
    fname_tSN = f'{save_folder}/tSN_seall_d{dose_level}_c30o5_IO{isIO}_Ud{Ud}_extind{ext_ind}.txt'
...
if __name__ == '__main__':
  ...
  parser.add_argument('--ext_ind', type=int, help="extent index?")
  args = parser.parse_args()
  run_cho(args.Ud, args.dose_level, args.isIO, args.ext_ind)
