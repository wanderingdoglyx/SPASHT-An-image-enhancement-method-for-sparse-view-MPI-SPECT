...
def run_cho(dl_version, Ud, dose_level, isIO, bt_size, lambda_val_ind_chdiff, lambda_val_ind_mdiff, ext_ind):
  ...
  save_folder = f'{base_folder}/learning/v1_july_22_unet_3d/den_3d_v{dl_version}/pred_tSN_fix3_ms_comb_mirirv3_def_ext/extind_{ext_ind}/lmbd_mdiff{lambda_val_ind_mdiff}/d{dose_level}/'
  ...
  if isIO == 1:
    ...
    fname_tSN = f'{save_folder}/tSN_seall_d{dose_level}_c30o5_IO{isIO}_Ud{Ud}_lmbdchdiff{lambda_val_ind_chdiff}_lmbdmdiff{lambda_val_ind_mdiff}_extind_{ext_ind}_rerun.txt'
...
if __name__ == '__main__':
  ...
  parser.add_argument('--ext_ind', type=int, help="ext_ind?")
  args = parser.parse_args()
  run_cho(args.dl_version, args.Ud, args.dose_level, args.isIO, args.batch_size, args.lambda_val_ind_chdiff, args.lambda_val_ind_mdiff, args.ext_ind)
