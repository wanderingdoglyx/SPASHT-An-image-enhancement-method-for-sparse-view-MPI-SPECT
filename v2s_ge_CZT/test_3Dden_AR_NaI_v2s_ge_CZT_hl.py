...
def test_seg3D(base_folder, weights_name, loss_fn_name, subsample_level, num_iter, bt_size, num_epochs, learning_folder,
  ...
  #pat_id_arr_fname = f'{base_folder}/test_pat_list_hl.txt'
  ...
  pat_id_arr_fname = f'/data01/user-storage/y.zezhang/2024_subsample_project/document/collimator_record/patients_with_NaI.txt'
