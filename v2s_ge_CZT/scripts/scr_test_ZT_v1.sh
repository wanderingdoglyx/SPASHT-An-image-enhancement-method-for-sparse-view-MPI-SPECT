...
#do
      ...
      do
        ...
        do
          ...
          #do
            ...
            echo "python3 test_3Dden_AR_v${version}_ZT.py ${arglist[@]}"
            python3 test_3Dden_AR_v${version}_ZT.py ${arglist[@]}
          #done
        done
      done
    done
  ...
  do
    ...
    #do
      ...
      echo "python3 test_3Dden_AR_v${version}_hl_ZT.py ${arglist[@]}"
      python3 test_3Dden_AR_v${version}_hl_ZT.py ${arglist[@]}
    #done
  done
#done
