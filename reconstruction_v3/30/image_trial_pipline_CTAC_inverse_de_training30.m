...
patient_list_folder='/data01/user-storage/y.zezhang/2024_subsample_project/mod_subsample_projection/30/training_de_def';
...
for k = 1 : length(subFolders)
    ...
    patient_folder=fullfile(brench_folder_name,subFolders(length(subFolders)-k+1).name);
    patient_id=subFolders(length(subFolders)-k+1).name;
