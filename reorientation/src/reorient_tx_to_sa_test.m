function recon_sa = reorient_tx_to_sa_test(...
  ...
  try
    ...
    fdir = [fullfile('/data01/user-storage/zitong/data/cardiac_trainsmission_less/patient_study/src/sa/dependencies/', 'all_recon_sa_v3') filesep];
  ...
  try
    ...
    fdir = [fullfile('/data01/user-storage/zitong/data/cardiac_trainsmission_less/patient_study/src/sa/dependencies/', 'recon_prim') filesep];
