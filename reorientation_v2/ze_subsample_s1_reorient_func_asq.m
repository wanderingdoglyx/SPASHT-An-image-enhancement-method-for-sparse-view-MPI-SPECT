function ze_subsample_s1_reorient_func_asq(patient_list,def_name, AC_method, category,slice_number)
    ...
    for ind_pat = 1:length(pat_id_arr)
        ...
        if strcmp(category, 'healthy')
            ...
            try
                pat_name=['orig_proj_',def_name,'_',pat_id,'_d1_it8.img'];
        ...
        elseif strcmp(category, 'diseased')
            ...
            pat_name=['mod_proj_',def_name,'_obj_',pat_id,'_it8.img'];
            ...
            %% reorient
            recon_sa = ze_subsample_reorient_tx_to_sa(pat_id, fdir_base, recon_tx, res_factor, ...
            flag_filter, filter);
