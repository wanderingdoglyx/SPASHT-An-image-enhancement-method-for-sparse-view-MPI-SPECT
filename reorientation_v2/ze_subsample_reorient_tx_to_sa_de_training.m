function recon_sa = ze_subsample_reorient_tx_to_sa_de_training(...
    ...
    try
        ...
        series_desc_sa_recon ='Short.Axis.ReconSA';
        fdir = [fullfile(fdir_base, 'all_recon_sa') filesep]; 
    ...
    try
        fdir = [fullfile(fdir_base, 'reco_prim') filesep];
        S = get_dir(fdir, '_ReconPrim_', pat_id);
    catch
