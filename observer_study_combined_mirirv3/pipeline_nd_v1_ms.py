...
def run_cho(Ud, dose_level, isIO):
  ...
  save_folder = f'{base_folder}/test_data_sa_wd_tSN_fix3_remsev500ext90addsev175_combined_mirirv3_48cube'
  ...
  # write txt
  ff_all = {'diseased':defaultdict(list), 'healthy':defaultdict(list)}
