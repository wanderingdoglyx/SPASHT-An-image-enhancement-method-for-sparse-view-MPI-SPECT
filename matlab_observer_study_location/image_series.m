...
filename='recon_pat00096097_d1_it8_c30o5.img';
dataType='float32';
dataShape=Inf;
...
png_file_name=strcat(png_file_name,'.png');
    
imwrite(imgseries,png_file_name,'png');

dcm_file_name='2.16.840.1.114362.1.11843457.25174189512.624965422.204.8475.dcm';
...
for i = 1:size(normalizedData, 4)
    ...
    if i == 1
        imwrite(indexedSlice, cmap, dcm_filename, 'gif', 'LoopCount', Inf, 'DelayTime', delayTime);
    else
        imwrite(indexedSlice, cmap, dcm_filename, 'gif', 'WriteMode', 'append', 'DelayTime', delayTime);
    end
end

disp(['GIF created successfully: ' dcm_filename]);
