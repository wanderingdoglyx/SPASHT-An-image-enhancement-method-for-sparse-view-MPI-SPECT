...
sa_base='/data01/user-storage/y.zezhang/2024_subsample_project/mod_Neural_network_training/30/testing_demist'
save_folder = '/data01/user-storage/y.zezhang/2024_subsample_project/mod_SA_images/30'
            ...
            for index, di_item in enumerate(diseased_patients):
                if diag == 'diseased':
                    for di_item in diseased_patients:
                        ...
                        patient=diseased_patients[index]
