...
#observer_study_list = ['d15_lmbdchdiff0_nn_CZT','d15_lmbdchdiff7_nn_CZT','d15_lmbdchdiff0_nn_NAI','d15_lmbdchdiff7_nn_NAI']
...
for study_project in observer_study_list:
  ...
  fname_tSN = f'{save_folder}/t_loc_{location_setting_combined}_sev_{severity_setting_combined}_ext_{extent_setting_combined}_subsample{study_project}_IO{isIO}_Ud{Ud}_CZT.txt'
