...
for study_project in observer_study_list:
  ...
  fname_tSN = f'{save_folder}/t_de_loc_{location_setting_combined}_sev_{severity_setting_combined}_ext_{extent_setting_combined}_subsample{study_project}_IO{isIO}_Ud{Ud}.txt'
