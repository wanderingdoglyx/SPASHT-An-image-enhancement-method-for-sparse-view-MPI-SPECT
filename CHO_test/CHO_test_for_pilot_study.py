...
for study_project in observer_study_list:
  ...
  save_folder = f'/data01/user-storage/y.zezhang/2024_subsample_project/observer_study/pilot_study'
  sub_base_folder=os.path.join(base_folder,str(study_project))
  
  #print(sub_base_folder,'sssssssssssssss')
  ...
  fname_tSN = f'{save_folder}/t_subsample{study_project}_IO{isIO}_Ud{Ud}.txt'
