...
input_file_czt = '/data01/user-storage/y.zezhang/2024_subsample_project/document/collimator_record/patients_with_CZT.txt'           # Input file containing the list of patients
output_file_czt_def = '/data01/user-storage/y.zezhang/2024_subsample_project/document/collimator_record/patients_with_CZT_def.txt'   # Output file for the first half of patients
output_file_czt_hl = '/data01/user-storage/y.zezhang/2024_subsample_project/document/collimator_record/patients_with_CZT_hl.txt'  # Output file for the second half of patients

input_file_nai = '/data01/user-storage/y.zezhang/2024_subsample_project/document/collimator_record/patients_with_NaI.txt'           # Input file containing the list of patients
output_file_nai_def = '/data01/user-storage/y.zezhang/2024_subsample_project/document/collimator_record/patients_with_NaI_def.txt'   # Output file for the first half of patients
output_file_nai_hl = '/data01/user-storage/y.zezhang/2024_subsample_project/document/collimator_record/patients_with_NaI_hl.txt'  # Output file for the second half of patients
