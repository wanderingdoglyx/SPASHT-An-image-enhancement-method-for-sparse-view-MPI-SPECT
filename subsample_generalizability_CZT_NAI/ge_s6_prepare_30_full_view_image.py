...
for sl in sparse_level:
    ...
    source_folder_1 = f'/data01/user-storage/y.zezhang/2024_subsample_project/mod_SA_images/30/diseased'  # Replace with the path to your first folder
    source_folder_2 = f'/data01/user-storage/y.zezhang/2024_subsample_project/mod_SA_images/30/healthy'  # Replace with the path to your second folder
