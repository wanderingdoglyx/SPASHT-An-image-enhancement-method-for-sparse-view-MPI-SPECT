...
def copy_specific_files(src_dir, dst_dir,filename,patient):
   ...
   # for filename in os.listdir(src_dir):
    ...
    new_filename = f"mod_proj_{loc}21{ext}{sev}_obj_{patient}.a00"
...
# Example usage
source_folder = '/data03/user-storage/y.zezhang/Ashequr/data_spie/test_mc_castor'
destination_folder = '/data01/user-storage/y.zezhang/2024_subsample_project/mod_subsample_projection/30/def_asq'
file_patterns = ['.a00', '.h00']
source_folder_175 = '/data01/user-storage/y.zezhang/data_from_zitong_real_patient_project/mod_prj_v2'

patient_list=os.listdir('/data01/user-storage/y.zezhang/asheq_file/data_spie/low_dose_proj_v2') 
    ...
    for ext in extension:
        for sev in severity:
            for loc in location:
                ...
                #sub_source_folder=source_folder+'/'+patient
                sub_source_folder=source_folder_175+'/'+patient
                filename=f'mp_{loc}21{ext}{sev}_{patient}_d1.a00'
