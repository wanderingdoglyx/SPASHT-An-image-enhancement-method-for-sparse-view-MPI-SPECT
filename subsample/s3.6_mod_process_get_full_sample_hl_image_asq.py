...
# Example usage
source_folder = '/data01/user-storage/y.zezhang/asheq_file/data_spie/low_dose_proj_v2_hl'
destination_folder = '/data01/user-storage/y.zezhang/2024_subsample_project/mod_subsample_projection/30/hl_asq'
file_patterns = ['d1.a00', 'd1.h00']

patient_list=os.listdir('/data01/user-storage/y.zezhang/asheq_file/data_spie/low_dose_proj_v2_hl') 
