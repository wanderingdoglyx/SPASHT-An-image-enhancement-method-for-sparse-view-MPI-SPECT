...
save_path_base='/data01/user-storage/y.zezhang/2024_false_defect_project/pilot_study/DEMIST';
...
submission_folder='/data01/user-storage/y.zezhang/2024_false_defect_project/pilot_study/all_submission';
            ...
            for defect_setting_index=1:1:length(defect_setting)
                ...
                for extend_setting_index=1:1:length(extend_setting)
                    ...
                    for serverity_setting_index=1:1:length(serverity_setting)
                        ...
                        De_folder_name=append(defect_setting_cur,'21',extend_setting_cur,'s',serverity_setting_cur);
                        DEMIST_lowdose=append('recon_pat',pat_No,'_',De_folder_name,'_',dose_cur,'_it8_b32_lmbdchdiff',lmbdchdiff,'_lmbdmdiff0.img');


                        pat_filefolder=append(sa_folder,'/',defect_setting_cur,'21',extend_setting_cur,'s',serverity_setting_cur);
