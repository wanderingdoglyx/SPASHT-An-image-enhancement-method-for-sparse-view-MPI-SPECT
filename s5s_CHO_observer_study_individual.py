...
#observer_study_list=['10']
#observer_study_list=['30']
#observer_study_list=['5']
#observer_study_list=['15']
#observer_study_list=['d10_lmbdchdiff7_nn']
#observer_study_list=['d10_lmbdchdiff0_nn']
#observer_study_list=['d15_lmbdchdiff7_nn']
#observer_study_list=['d15_lmbdchdiff0_nn']
#observer_study_list=['d5_lmbdchdiff7_nn']
observer_study_list=['d5_lmbdchdiff0_nn']
...
for study_project in observer_study_list:
  ...
  fname_tSN = f'{save_folder}/t_loc_{location_setting_combined}_sev_{severity_setting_combined}_ext_{extent_setting_combined}_subsample{study_project}_IO{isIO}_Ud{Ud}.txt'
