...
#slice_number=10
testing30full_demist='/data01/user-storage/y.zezhang/2024_subsample_project/mod_Neural_network_training/30/testing_demist'
...
testing_patient_demist = os.listdir(testing30full_demist) 


copy_directory_base_training='/data01/user-storage/y.zezhang/data_for_zezhang_mar29/training_data_sa_wd'
copy_directory_base_testing='/data01/user-storage/y.zezhang/data_for_zezhang_mar29/test_data_mirirv3_sa_wd'
copy_directory_base_testing_demist='/data01/user-storage/y.zezhang/data_for_zezhang_mar29/test_data_sa_wd'
...
copy_and_merge_folders(copy_directory_base_testing_demist, testing_destination_directory_base, testing_patient_demist)
    
copy_and_merge_folders(copy_directory_base_testing, testing_destination_directory_base, testing_patient)

copy_and_merge_folders(copy_directory_base_training, training_destination_directory_base, training_patient)
