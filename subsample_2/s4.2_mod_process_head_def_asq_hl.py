...
# Example usage
folder_path = '/data03/user-storage/y.zezhang/Ashequr/data_spie/low_dose_proj_v2' 
save_path='/data01/user-storage/y.zezhang/2024_subsample_project/mod_subsample_projection/30/def_asq_hl'
patient_list=os.listdir('/data01/user-storage/y.zezhang/2024_subsample_project/mod_subsample_projection/30/def_asq') 
