...
patient_list_def=os.listdir('/data01/user-storage/y.zezhang/2024_subsample_project/mod_subsample_projection/30/training_de_def') 
patient_list_hl=os.listdir('/data01/user-storage/y.zezhang/2024_subsample_project/mod_subsample_projection/30/training_de_def')

#patient_list_hl = "/data01/user-storage/y.zezhang/demist/train_mc_castor_mirirv12_apr3"
#hl_patient_list_path = '/data03/user-storage/y.zezhang/Ashequr/data_spie_v2/train_mc_castor'
...
for subsample_slices in subsample_slices_list:
    ...
    for patient in patient_list_hl:
        ...
        image_file=f'{folder_path}/training_de_hl/{hl_image_file_name}'
        head_file=f'{folder_path}/training_de_hl/{hl_head_file_name}'
    ...
    for patient in patient_list_def:    
        for ext in extension:
            for sev in severity:
                for loc in location:
                    ...
                    image_file=f'{folder_path}/training_de_def/{patient}/{image_file_name}'                
                    head_file=f'{folder_path}/training_de_def/{patient}/{head_file_name}'
        ...
        CT_image_file=f'{folder_path}/training_de_def/{patient}/{CT_image_file_name}'
        CT_head_file=f'{folder_path}/training_de_def/{patient}/{CT_head_file_name}'
