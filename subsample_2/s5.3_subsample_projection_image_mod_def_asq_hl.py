...
patient_list_hl=os.listdir('/data01/user-storage/y.zezhang/2024_subsample_project/mod_subsample_projection/30/def_asq')
...
for subsample_slices in subsample_slices_list:
    ...
    for patient in patient_list_hl:
        ...
        image_file=f'{folder_path}/def_asq_hl/{hl_image_file_name}'
        head_file=f'{folder_path}/def_asq_hl/{hl_head_file_name}'
