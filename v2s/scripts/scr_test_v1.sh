...
#do
      ...
      do
        ...
        do
          ...
          #do
            ...
            echo "python3 test_3Dden_AR_v${version}.py ${arglist[@]}"
            python3 test_3Dden_AR_v${version}.py ${arglist[@]}
          #done
        done
      done
    done
  ...
  do
    ...
    #do
      ...
      echo "python3 test_3Dden_AR_v${version}_hl.py ${arglist[@]}"
      python3 test_3Dden_AR_v${version}_hl.py ${arglist[@]}
    #done
  done
#done
