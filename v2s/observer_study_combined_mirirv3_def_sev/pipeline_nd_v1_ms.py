...
def run_cho(Ud, dose_level, isIO, sev_ind):
  ...
  save_folder = f'{base_folder}/test_data_sa_wd_tSN_fix3_remsev500ext90addsev175_combined_mirirv3_def_sev_48cube/sevind_{sev_ind}'
  ...
  if isIO == 1:
    ...
    fname_tSN = f'{save_folder}/tSN_seall_d{dose_level}_c30o5_IO{isIO}_Ud{Ud}_sevind{sev_ind}_ext45.txt'
    ...
    fname_tSN = f'{save_folder}/tSN_seall_d{dose_level}_c30o5_IO{isIO}_Ud{Ud}_sevind{sev_ind}.txt'
    with open(fname_tSN, 'w') as f:
      f.writelines('Initial Line\nLarge\n')
      for dd in tN:
          f.writelines(f"{dd}\n")
...
if __name__ == '__main__':
  ...
  parser.add_argument('--sev_ind', type=int, help="severity index?")
  args = parser.parse_args()
  run_cho(args.Ud, args.dose_level, args.isIO, args.sev_ind)
