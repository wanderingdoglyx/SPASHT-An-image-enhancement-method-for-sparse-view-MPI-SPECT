...
def copy_and_merge_folders(src_dir, dest_dir, folder_names):
    ...
    for folder_name in folder_names:
        src_folder_path = os.path.join(src_dir, folder_name,'CTAC')##############################################
...
testing30full='/data01/user-storage/y.zezhang/2024_subsample_project/mod_Neural_network_training/30/testing_total'
