...
file1_data = read_groups_from_file(f'/data01/user-storage/y.zezhang/2024_subsample_project/mod_SA_images/{folder1}/t_ZT_{cameria}_loc_a_i_sev_100_175_250_ext_30_60_subsample{subsample_level1}_IO0_Ud32.txt')

file2_data = read_groups_from_file(f'/data01/user-storage/y.zezhang/2024_subsample_project/mod_SA_images/{folder2}/t_ZT_{cameria}_loc_a_i_sev_100_175_250_ext_30_60_subsample{subsample_level2}_IO0_Ud32.txt')

#file2_data = read_groups_from_file(f'/data01/user-storage/y.zezhang/2024_subsample_project/mod_SA_images/{folder2}/t_{cameria}_loc_a_i_sev_100_175_250_ext_30_60_subsample{folder2}_IO0_Ud32.txt')
