...
file1_data = read_groups_from_file(f'/data01/user-storage/y.zezhang/2024_subsample_project/mod_SA_images/{folder1}/t_ZT_male_loc_a_i_sev_100_175_250_ext_30_60_subsample{subsample_level1}_IO0_Ud32.txt')
...
file2_data = read_groups_from_file(f'/data01/user-storage/y.zezhang/2024_subsample_project/mod_SA_images/{folder2}/t_ZT_male_loc_a_i_sev_100_175_250_ext_30_60_subsample{subsample_level2}_IO0_Ud32.txt')

#output=f'{folder1}_{folder2}.csv'
output=f'{folder1}_{folder2}_male.csv'
# Write to a CSV file
