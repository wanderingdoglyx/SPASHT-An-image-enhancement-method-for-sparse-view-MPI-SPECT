...
pat_id_arr_fname = f'/data01/user-storage/y.zezhang/2024_subsample_project/document/collimator_record/patients_with_NaI_ZT_test_def.txt'
diseased_patients = np.loadtxt(pat_id_arr_fname, dtype = 'str', comments="#", delimiter=",", unpack=False)

pat_id_arr_fname = f'/data01/user-storage/y.zezhang/2024_subsample_project/document/collimator_record/patients_with_NaI_ZT_test_hl.txt' 
...
observer_study_list = os.listdir('/data01/user-storage/y.zezhang/2024_subsample_project/mod_SA_images_ge')
#observer_study_list = ['d10_lmbdchdiff7_nn_CZT']

def_folder='/data01/user-storage/y.zezhang/2024_subsample_project/mod_Neural_network_training/centroid_mask/ge_total'
base_folder = '/data01/user-storage/y.zezhang/2024_subsample_project/mod_SA_images_ge'
...
for study_project in observer_study_list:
  ...
  fname_tSN = f'{save_folder}/t_loc_{location_setting_combined}_sev_{severity_setting_combined}_ext_{extent_setting_combined}_subsample{study_project}_IO{isIO}_Ud{Ud}_NaI.txt'
