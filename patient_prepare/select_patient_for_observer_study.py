...
output_file = f'{source_path}/observer_study_patient_list/pat_id_diseased_pilot_defect_selected.txt' # Replace with the path of your output file
...
output_file = f'{source_path}/observer_study_patient_list/pat_id_healthy_pilot.txt' # Replace with the path of your output file
select_random_rows(input_file, output_file, n, seed_value)